...
# model.save_weights(path + "keras29_5_save_weights1.weights.h5") # 초기 가중치만 저장

# model = load_model(path + "keras29_1_save_model.keras") # 모델 구조 + 초기 가중치 불러오기
# model.load_weights(path + "keras29_5_save_weights1.weights.h5") # 초기 가중치 불러오기
...
# model.save_weights(path + "keras29_5_save_weights2.weights.h5") # 학습된 가중치만 저장

model.load_weights(path + "keras29_5_save_weights2.weights.h5") # 학습된 가중치 불러오기

...
dense3 = Dense(6, name='jy3')(drop2)
output1 = Dropout(0.4)(dense3)
...
print(date) # 2026-09-14 11:47:58.481433
...
print(filepath) # ./_save/keras30/k30_0914_1320_0001-2634.633057.keras
######################## mpc 세이브 파일명 만들기 끝 ###########################
...
hist = model.fit(x_train, y_train, 
                 epochs=100000, batch_size=32, validation_data=(x_val, y_val), 
                 callbacks=[es, mcp],
                 )

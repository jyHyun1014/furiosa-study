...
from tensorflow.keras.layers import Dense, Dropout, Conv2D, Flatten, BatchNormalization, Activation
...
# 2. 모델 구성
model = Sequential()
model.add(Conv2D(64, (3,3), input_shape=(32, 32, 3))) # input_shape=(height, width, channel)

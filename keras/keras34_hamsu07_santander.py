...
dense1 = Dense(10, name='jy1')(input1)
drop1 = Dropout(0.4)(dense1)
dense2 = Dense(10, name='jy2')(drop1)
drop2 = Dropout(0.4)(dense2)
dense3 = Dense(10, name='jy3')(drop2)
dense3 = Dense(5, name='jy3')(dense3)
output1 = Dense(1, name='jy3')(dense3)
...
filepath = "".join(["./_save/keras33/", "k33_07_", date, filename]) # 모델 저장 경로

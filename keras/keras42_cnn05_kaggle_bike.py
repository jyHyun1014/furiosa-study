...
x_valid = x_valid.reshape(-1, 8, 1, 1)
test_csv = test_csv.reshape(-1, 8, 1, 1)
print(x_train.shape, y_train.shape) # (8708, 8, 1, 1) (8708,)
print(x_valid.shape, y_valid.shape) # (2178, 8, 1, 1) (2178,)

# 2. 모델 구성
model = Sequential()
model.add(Conv2D(16, (2,1), padding='same', activation='relu', input_shape=(8, 1, 1)))
...
# 결과
r2 : 0.2885003685951233
mse : 23484.421875
rmse : 153.24627850293788
걸린시간 :  356.41 초
# 캐글 점수
RMSLE : 
####################################

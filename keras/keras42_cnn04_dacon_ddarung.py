...
x_valid = x_valid.reshape(-1, 9, 1, 1)
test_csv = test_csv.reshape(-1, 9, 1, 1)
print(x_train.shape, y_train.shape) # (1062, 9, 1, 1) (1062,)
print(x_valid.shape, y_valid.shape) # (266, 9, 1, 1) (266,)

# 2. 모델 구성
model = Sequential()
model.add(Conv2D(16, (2,1), padding='same', activation='relu', input_shape=(9, 1, 1)))
...
# 결과
R2 : 0.6055571766319063
MSE : 2875.6691591160493
RMSE : 53.62526605170411
걸린시간 :  12.01 초
# 데이콘 점수
RMSE : 
#######################################
...
# 결과
R2 : 0.6136164628171243
MSE : 2816.9132650946385
RMSE : 53.074600941454456
걸린시간 :  14.03 초
# 데이콘 점수
RMSE : 
#######################################

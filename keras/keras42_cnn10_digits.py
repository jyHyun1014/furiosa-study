...
print(x_train.shape, y_train.shape) # (1437, 8, 8, 1) (1437,)
print(x_test.shape, y_test.shape) # (360, 8, 8, 1) (360,)

# 2. 모델 구성
model = Sequential()
model.add(Conv2D(16, (2,2), activation='relu', input_shape=(8, 8, 1)))

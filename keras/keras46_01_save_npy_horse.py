...
xy = datagen.flow_from_directory( # Found 1027 images belonging to 2 classes
    path, # 경로
    target_size=(150,150),
    batch_size=10000000,
...
print(x_train.shape, y_train.shape, x_test.shape, y_test.shape) # (718, 150, 150, 3) (718,) (309, 150, 150, 3) (309,)
...
# accuracy_score : 0.9967637540453075
# 걸린시간 : 740 초
